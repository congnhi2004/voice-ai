...
class Settings:
    ...
    gcs_job_metadata_prefix: str = "voice-ai/video/jobs"
    signed_url_ttl_seconds: int = 3600
    video_job_dispatch_mode: str = "local_inline"
    ...
    cloud_tasks_handler_url: str | None = None
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        gcs_job_metadata_prefix=os.getenv("GCS_JOB_METADATA_PREFIX", "voice-ai/video/jobs").strip("/"),
        signed_url_ttl_seconds=int(os.getenv("SIGNED_URL_TTL_SECONDS", "3600")),
        video_job_dispatch_mode=os.getenv("VIDEO_JOB_DISPATCH_MODE", "local_inline").lower(),
        internal_task_token=os.getenv("INTERNAL_TASK_TOKEN"),
        cloud_tasks_project_id=os.getenv("CLOUD_TASKS_PROJECT_ID") or os.getenv("GCP_PROJECT_ID"),
        cloud_tasks_location=os.getenv("CLOUD_TASKS_LOCATION", "us-central1"),
        cloud_tasks_queue=os.getenv("CLOUD_TASKS_QUEUE") or None,
        cloud_tasks_service_account_email=os.getenv("CLOUD_TASKS_SERVICE_ACCOUNT_EMAIL") or None,
        cloud_tasks_audience=os.getenv("CLOUD_TASKS_AUDIENCE") or None,
        cloud_tasks_handler_url=os.getenv("CLOUD_TASKS_HANDLER_URL") or None,
        cloud_tasks_dispatch_deadline_seconds=int(os.getenv("CLOUD_TASKS_DISPATCH_DEADLINE_SECONDS", "1800")),
